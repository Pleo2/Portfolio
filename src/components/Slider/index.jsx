...
export default function Slider() {
    return (
        <section
            className={`${style.slider} relative m-auto mt-24 h-[50px] w-[310px] flex items-center justify-start overflow-hidden rounded-mD md:w-[600px] md:mt-44 lg:w-[525px] lg:mt-44 z-10`}
        >
            <div
