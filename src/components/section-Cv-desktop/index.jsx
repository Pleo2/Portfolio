    ...
    return (
        <>
            <motion.div
                ...
                className='absolute top-0 left-24 md:top-12 md:left-[22rem] lg:flex lg:m-auto lg:justify-center lg:gap-8 lg:mt-[28rem] xl:left-1/2 xl:-translate-x-1/2 xl:item-center'
            >
                <DownloadCv />
